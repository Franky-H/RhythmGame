...
{ 
	...
	MAKE_NOTE(start_x1,random1,hit_check1,0xFFFF) /*call MAKE_NOTE macro & start_x1 is 480 in init */
	...
	{
		MAKE_NOTE(start_x2,random2,hit_check2,0xFFFF) /*different kind Note is made*/
...
void timer2_handler(void)
{
	...
	if(d_min==0 && d_sec==40)	rINTMSK1 &= ~BIT_TIMER2;
